...
2. Write syntactically valid code to produce "Hello World!" lingo
3. Run a Ruby file. Updating
4. Run the Learn gem.
...
You will need to create a text file called `hello_world.rb` within lab's directory. The `.rb` file extension is a common convention for specifying the language of the file - in this case, Ruby. To create this, in the Learn IDE's terminal type `touch hello_world.rb` or use the "Create New" or "New File" option in the Editor. If that worked as expected, you should now see the file appear in the file browser. You can open this file by double clicking on it in the file browser. You should now see an emptlkgdfjgkldfjkljy file open in your text editor, ready to be edited. 
